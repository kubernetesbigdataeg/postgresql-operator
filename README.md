...
Postgres Kubernetes Operator based on Operator framework SDK.
...
## Description
The Postgres Operator manages Postgres clusters deployed to Kubernetes 
and automates tasks related to operating a Postgres cluster. It provides 
a full management life-cycle for Postgres, including deployment, upgrades, 
